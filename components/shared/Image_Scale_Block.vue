    ...
    <client-only>
      ...
      >
        ...
        <div :class="imageScaleImgClasses"
             :style="'transform: scale('+this.imgScale+'); opacity: '+this.imgOpacity+'; background-image: url('+img+')'">
        </div>
        <div :class="imageScaleImgClassesMobile"
             :style="'transform: scale('+this.imgScale+'); opacity: '+this.imgOpacity+'; background-image: url('+imgMobile+')'">
        </div>
        </div>
      </intersect>
    </client-only>
...
export default {
  ...
  computed: {
    ...
    imageScaleImgClasses() {
      return ['image-scale-img', 'desktop',
        {
    ...
    imageScaleImgClassesMobile() {
      return ['image-scale-img', 'mobile',
        {
          'image-scale-img-width-hover': this.appointment === 'project' ||
            this.appointment === 'news' ||
            this.appointment === 'people' ||
